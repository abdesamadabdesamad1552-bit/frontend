  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
        <div className="bg-brand-white rounded-2xl max-w-md w-full overflow-hidden animate-bounce-in">
          {/* Header */}
          <div className="bg-gradient-to-l from-brand-gold to-brand-gold-dark px-6 py-4 text-center">
