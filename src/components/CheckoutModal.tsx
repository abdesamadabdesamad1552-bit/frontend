...
export default function CheckoutModal() {
    ...
    return (
      <>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          <div className="bg-brand-white rounded-2xl max-w-md w-full p-8 text-center">
  ...
  return (
    <>
      ...
      />
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
        <div className="bg-brand-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
          {/* Header */}
